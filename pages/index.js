  ...
  return (
    <><>
      ...
      <Head>
        ...
        <meta property="og:site_name" content="FragNite" />
          ...
          <div className="flex flex-col items-center justify-center lg:flex-row">
            ...
            <div className="pt-8 sm:pt-10 lg:pl-8 lg:pt-0">
              ...
              <Link href={'/blogs'}><div className="buttons text-center md:text-left">
                <button className='mt-6 flex items-center justify-center rounded bg-primary px-8 py-3 font-header text-lg font-bold uppercase text-white hover:bg-grey-20'>All Blogs</button>
              </div></Link>
            </div>
          </div>
        </div>
          ...
          <div className="w-full pl-0 pt-10 sm:w-3/4 lg:w-2/5 lg:pl-12 lg:pt-0">
            <div>
              <div className="flex items-end justify-between">
                ...
                <h3 className="font-body text-3xl font-bold text-primary">{profile.htmlcss}%</h3>
              </div>
            ...
            <div className="pt-6">
              <div className="flex items-end justify-between">
                ...
                <h3 className="font-body text-3xl font-bold text-primary">{profile.python}%</h3>
              </div>
              <div className="mt-2 h-3 w-full rounded-full bg-lila">
            ...
            <div className="pt-6">
              <div className="flex items-end justify-between">
                ...
                <h3 className="font-body text-3xl font-bold text-primary">{profile.javascript}%</h3>
              </div>
              <div className="mt-2 h-3 w-full rounded-full bg-lila">
                <div className="h-3 rounded-full bg-primary" style={{ "width": "40%" }}></div>
              </div>
            </div>
            <div className="pt-6">
              <div className="flex items-end justify-between">
                <h4 className="font-body font-semibold uppercase text-black">Mongo Db</h4>
                <h3 className="font-body text-3xl font-bold text-primary">{profile.mongo}%</h3>
              </div>
              <div className="mt-2 h-3 w-full rounded-full bg-lila">
          ...
          <div className="group rounded px-8 py-12 shadow hover:bg-primary">
            ...
            <div className="text-center">
              ...
              <p className="text-grey pt-4 text-sm group-hover:text-white md:text-base">
                I'm into Web development scince 2020. I'm a full-stack developer who can build web applications and websites.
              </p>
            </div>
          </div>
          {<div className="group rounded px-8 py-12 shadow hover:bg-primary">
            ...
            <div className="text-center">
              ...
              <p className="text-grey pt-4 text-sm group-hover:text-white md:text-base">
                I write blogs and share my personal experience, and some tips and tricks for easy programing.
              </p>
            </div>
          </div>}
          {/*<div className="group rounded px-8 py-12 shadow hover:bg-primary">
        ...
        <div className="container py-16 md:py-20">
          ...
          <div className="mx-auto grid w-full grid-cols-1 gap-6 pt-12 sm:w-3/4 lg:w-full lg:grid-cols-3 xl:gap-10">
            ...
            <a href="/post" className="shadow">
              ...
              <div className="bg-white py-6 px-5 xl:py-8">
                <span clasfhsName="block font-body text-lg font-semibold text-black">My year in review 2020</span>
                <span className="block pt-2 font-body text-grey-20">Lorem ipsum dolor sit amet, consectetur adipiscing
                  elit, sed do
                  eiusmod tempor incididunt ut labore et dolore magna aliqua.</span>
              </div>
      ...
      <div className="container py-16 md:py-20" id="contact">
        ...
        <div className="mx-auto w-full pt-5 text-center sm:w-2/3 lg:pt-6">
          <p className="font-body text-grey-10">
            If you have any query you can reach me by filling the form below.
          </p>
        </div>
